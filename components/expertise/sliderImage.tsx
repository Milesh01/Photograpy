...
const ImageSlider = () => {
  ...
  return (
    <>
      ...
      <section className="container mx-auto text-white lg:py-12">
        <div className='grid grid-cols-1 lg:grid-cols-3 md:grid-cols-2 gap-10 items-end'>
          <div className="lg:pb-24 grid grid-cols-3 md:col-span-2 lg:col-span-1 mt-5">
          ...
          <AnimatePresence mode="wait" custom={direction}>
            ...
            <motion.div 
              className="lg:hidden md:flex justify-end space-x-4 md:pb-0 pb-4"
              initial={{ opacity: 0 }}
              animate={{ opacity: 1 }}
            ...
            <motion.a
              href="#"
              className="mt-10 md:mt-5 lg:hidden md:block text-gray-400 hover:text-white transition"
              whileHover={{ x: 5 }}
            >
              See all →
            </motion.a>
          ...
          <div className="md:col-span-2">
            ...
            <motion.div 
              className="mt-8 lg:flex hidden  items-center space-x-4"
              initial={{ opacity: 0 }}
              animate={{ opacity: 1 }}
              transition={{ delay: 0.3 }}
            >
            ...
            <motion.a
              href="#"
              className="mt-6 lg:flex hidden text-gray-300 hover:text-white transition"
              whileHover={{ x: 5 }}
            >
              See all →
            </motion.a>
